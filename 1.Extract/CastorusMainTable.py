...
def CastorusMainTable(url, headers):
  ...
  Maintable=pd.read_html(requests.get(url, headers=headers).text, attrs={'id': 'myTableResult'})
...
# DBTITLE 1,Main
url=['https://www.castorus.com/s/Levallois-perret,38504,-------------------------','https://www.castorus.com/s/Levallois+Perret,38504,-1---------------------------']#'https://www.castorus.com/s/Angers,19447,-------------------------', 'https://www.castorus.com/s/Evian+Les+Bains,32605,-1---------------------------']
